...
import A39 from '../../../img/asset 39.png'
            ...
            <div className=" grid grid-cols-2   pl-[60px]">
                ...
                <div className="">
                    <div className=" flex pb-6 pt-60">
                        <div className="">
                            <img src={A39} alt="" className=' w-[80px] h-[80px] rounded-[20px]' />
                        </div>
                        <div className=" pl-[24px]">
                            <h3 className='font-semibold  text-[26px]'>DELL</h3>
                            <h6 className='text-[#008fa8] font-medium text-[20px]'>Event Management</h6>
                        </div>
                    </div>
                ...
                <div className=" bg-[#24425f] pb-12 pt-60 px-32">
                    <div className="">
