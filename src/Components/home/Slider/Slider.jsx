      ...
      >
        ...
        <SwiperSlide>
          <div className=" md:grid grid-cols-2 pt-[30px] pb-[100px] px-[70px]  ">
            ...
            <div >
             <img src={A10} alt=""  className="  relative  left-[14px]  w-[70%] max-md:w-[100%]
    top-[-17px]"/>
            </div>
          </div>
        </SwiperSlide>
      </Swiper>
<img src={A11} alt=""  className=" absolute  top-0   w-[67%] max-md:w-[100%] h-auto  z-0 right-0  overflow-hidden bg-cover  max-md:hidden
    "/>
    </>
  );
}
